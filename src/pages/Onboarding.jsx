...
const ONBOARDING_STEPS = [
  ...
  { type: 'radio', id: 'gender_expression', label: "What's your gender expression?", required: true, options: ['Androgynous / Andro', 'Butch', 'Chapstick', 'Femme', 'Futch', 'Gender non conforming', 'High femme', 'Masc', 'Masc-of-centre', 'Queer femme', 'Queer masc', 'Sapphic', 'Soft butch', 'Stem', 'Tomboy'] },
  ...
  { type: 'radio', id: 'children', label: 'Do you have children?', required: true, options: ['Child free', 'Child free, dating people with children', 'Have children', "Have children, don't want more", 'Have children, open to more', 'Want children', 'Prefer not to say'] },
  { type: 'text', id: 'job_title', label: "What's your job title?", placeholder: 'What do you do?', required: true },
  { type: 'intro', id: 'intro_profile', body: "Now let's build out your profile so everyone knows how awesome you are" },
  { type: 'photos', id: 'photos', label: 'Add photos (optional)', hint: "We recommend having a headshot for your first photo — that always helps get the best matches", min: 0, max: 6, required: false },
  ...
  { type: 'intro', id: 'intro_intimate', body: "To finish a couple of more intimate questions, if you don't mind", note: "(remember you can always hide these answers on your profile or skip them)" },
  ...
  { type: 'completion', id: 'done', body: "That's great!\nYou're all set!", note: "If you want to filter profiles you're seeing, just tap the icon on the top right." },
];
